...
const Recomendacoes = () => {
  const photos = [
    { src: '/assets/2024/IMG_0768.webp', alt: 'Foto do evento Rios do Espírito: primeiro dia', caption: 'Primeiro dia incrível do CRE!', likes: 3493, comments: 278 },
    { src: '/assets/2024/IMG_0161.webp', alt: 'Momento de adoração no evento Rios do Espírito', caption: 'Uma noite de profunda adoração ao nosso Rei Jesus', likes: 2847, comments: 195 },
    { src: '/assets/2024/IMG_0067.webp', alt: 'Mover no evento Rios do Espírito', caption: 'O mover do Espírito Santo foi simplesmente surreal.. tô arrepiado só de lembrar!', likes: 4120, comments: 321 }
  ];
              ...
              {photos.map((photo, idx) => (
                ...
                >
                  ...
                  <figcaption className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent flex flex-col justify-end p-4">
                    <p className="text-white font-aeonik font-semibold text-sm mb-3">{photo.caption}</p>
